      ...
      <div className="relative">
        ...
        <div className=" absolute top-0 rounded-r-full w-full bg-[#24126A] h-[80%] px-3 md:px-8 lg:px-12 xl:px-16 2xl:px-72  flex justify-center lg:justify-between items-center pt-52 pb-32 lg:gap-4 xl:gap-0">
          <div className="text-white flex flex-col items-center lg:items-start mt-16 lg:mt-36">
            ...
            <h1 className="text-3xl lg:text-[42px]  font-bold lg:mt-5 md:mt-3 pl-1 font-[sans-serif] leading-">
              Say Goodbye To
            </h1>
            <h1 className="text-3xl lg:text-[42px] font-bold lg:mt-5 md:mt-3 pl-1 font-[sans-serif]">
              Idle Money.
            </h1>
            <p className="pl-2 mt-8 font-semibold text-center lg:text-start">
              Invest Your spare change in Bitcoin and save with <br /> crypto to
              e arn interest in real time.
            </p>
      ...
      <div className=" bg-white 2xl:px-72 items-center justify-center flex flex-col  mt-24">
        <div className="flex justify-center">
          <div className="lg:w-1/2">
            ...
            <h1 className="text-center text-indigo-800 text-4xl font-semibold mt-4 ">
              Our Features
            </h1>
            <p className="mt-6 font-semibold text-gray-500 text-center w-full  md:px-6">
              There are many variations of passages of Lorem Ipsum available,
              but the majority have suffered alteration in some form. Lorem
              ipsum dolor sit amet consectetur adipisicing elit. Soluta optio
              deserunt rerum ipsa, voluptate doloribus.
            </p>
          </div>
        </div>
      </div>
