    ...
    <div className='px-3 md:px-8 lg:px-12 xl:px-16 2xl:px-72 mt-20 pb-20'>
        <div className='grid lg:grid-cols-3 gap-8'>
          {features.map((feature)=>(
            <div className='bg-white rounded-xl px-8 py-10 shadow-md border-t flex flex-col items-center hover:scale-105 transition-all ease-in-out duration-500 hover:border-t-4  hover:border-t-blue-600 hover:border-b-4 hover:border-b-blue-600'>
