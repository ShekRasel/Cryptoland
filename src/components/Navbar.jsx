...
function Navbar() {
  ...
  return (
    <nav className={`  font-semibold fixed w-full z-50`} id='nav'>
        ...
        <div className= {` px-3 md:px-8 lg:px-12 xl:px-16 2xl:px-72 py-4 lg:py-0 ${bgColor ? 'bg-white transition-all duration-500 z-50 ease-out text-indigo-800 w-full':'transition-all duration-500 ease-out text-white w-full'} w-full`}>
